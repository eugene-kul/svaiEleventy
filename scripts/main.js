...
// let cityResult2 = '';
// let cityResult3 = '';
// for (let i of city) {cityAray.push(i)}
// if (cityAray[city.length-1] !== 'о') {
// 	if (cityAray[city.length-1] === 'ь') {cityAray.splice(city.length-1,1);cityAray.push('и');}
// 	else if (cityAray[city.length-1] === 'а') {cityAray.splice(city.length-1,1);cityAray.push('ы');}
// 	else {cityAray.push('а');}
// }
// for (let i of cityAray) {cityResult1 += i;}
// console.log('лучший магазин '+cityResult1);

// cityAray = [];
// for (let i of city) {cityAray.push(i)}
// if (cityAray[city.length-1] !== 'о') {
// 	if (cityAray[city.length-1] === 'ь') {cityAray.splice(city.length-1,1);cityAray.push('и');}
// 	else if (cityAray[city.length-1] === 'а') {cityAray.splice(city.length-1,1);cityAray.push('е');}
// 	else {cityAray.push('у');}
// }
// for (let i of cityAray) {cityResult2 += i;}
// console.log('доставка по '+cityResult2);
...
// 	if (cityAray[city.length-1] === 'ь') {cityAray.splice(city.length-1,1);cityAray.push('и');}
// 	else if (cityAray[city.length-1] === 'а') {cityAray.splice(city.length-1,1);cityAray.push('е');}
// 	else {cityAray.push('е');}
// }
// for (let i of cityAray) {cityResult3 += i;}
// console.log('мы находимся в '+cityResult3);
...
document.addEventListener("DOMContentLoaded", function(event) {
	...
	if (dataPage != null && dataPage != '404' && dataPage != '') {
	...
	if (dataSidePage != null && dataSidePage != '') {
	...
	function sendRequestForms() {
		requestForms.forEach((requestForm) => {
			requestForm.addEventListener('submit', function(event) {
				...
				request.open('POST', 'https://ya-mobile.ru/mail-service/send.php', true);
